...
--   * Scopes mirror `lapis_memory.scope` semantics — you assert and
...
-- Lazy require to dodge module-load cycles (init.lua wires kg into
-- the public surface).
local function db()  return require("lapis.db") end
local function cfg() return require("lapis_memory").config end
